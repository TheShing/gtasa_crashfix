...
{
    ms_ValidAnimBlendAssociationMap.insert( pAnimBlendAssociation );
}
...
{
    ms_ValidAnimBlendAssociationMap.erase( pAnimBlendAssociation );
}
...
bool IsValidAnimBlendAssociation( CAnimBlendAssociationSAInterface* pAnimBlendAssociation )
{
    if ( !(ms_ValidAnimBlendAssociationMap.find ( pAnimBlendAssociation ) != ms_ValidAnimBlendAssociationMap.end () ) )
        return false;
